...
public class IntToStringTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("With String.valueOf() method, string5 = " + string5);
		
		//use format() method
		try {
			String string6 = String.format("%d", mainInt);
			System.out.println("With String.format() method, string6 = " + string6);
		...
		System.out.println("With Stringbuilder method: string7 = " + string7);
	}
}
